    ...
    "sotagger.js": [
      function (require, module, exports) {
        ...
        async function getResult(send_data) {
          ...
          try {
            const response = await fetch("https://10.23.105.29:5000/predict", options);
        ...
        async function genResult(send_data) {
          ...
          try {
            const response = await fetch("https://10.23.105.29:5000/suggest", options);
            const data = await response.json();
        ...
        async function getreposcore_s(send_data) {
          ...
          try {
            const response = await fetch("https://10.23.105.29:5000/repocheck", options);
            const data = await response.json();
